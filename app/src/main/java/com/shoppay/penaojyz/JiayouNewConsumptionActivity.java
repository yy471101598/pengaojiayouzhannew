...
public class JiayouNewConsumptionActivity extends FragmentActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jiayouconsumption);
        ac = this;
...
//					et_vipcard.setText(data.getStringExtra("codedata"));
    ...
    private void initView() {
        ...
        listFragments.add(new VipJiayouNewFragment());
        listFragments.add(new SanJiayouFragment());
