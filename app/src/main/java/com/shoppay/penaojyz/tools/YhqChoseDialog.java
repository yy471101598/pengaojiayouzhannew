...
import com.shoppay.penaojyz.adapter.YhqChoseAdapter;
...
public class YhqChoseDialog {
    public static void yhqChoseDialog(final Context context, final List<OilYhq> list,
        ...
        YhqChoseAdapter carListAdapter = new YhqChoseAdapter(context, list);
